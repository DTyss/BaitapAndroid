...
public class StoryAdapterNew extends RecyclerView.Adapter<StoryAdapterNew.StoryHolder> {
    
    private final ArrayList<StoryEntity> listStory;
    private final Context mContext;

    public StoryAdapterNew(ArrayList<StoryEntity> listStory, Context mContext) {
    ...
    @Override
    public void onBindViewHolder(StoryAdapterNew.StoryHolder holder, int position) {
